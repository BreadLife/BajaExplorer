...
temp_cvt_nom = Label(gui, text="Temp_CVT: ")
...
rpm_av_g_temp, rpm_arr_temp, temp_cvt_temp, rpm_mot_temp, throt_pos_temp, shv_pos_temp = 0,0,0,0,0,0

while (1):
    rpm_av_d_temp = Fetcher.COM15_fetch()
    rpm_av_g_temp = rpm_av_d_temp

    rpm_av_d.set(f'{rpm_av_d_temp}')
    rpm_av_g.set(f'{rpm_av_g_temp}')
    ...
    RPM_AVG.grid(column=1, row=0, padx=5, columnspan=2, sticky=W)
    RPM_AVD.grid(column=1, row=1, padx=5, columnspan=2, sticky=W)
    RPM_ARR.grid(column=1, row=2, padx=5, columnspan=2, sticky=W)
    TEMP_CVT.grid(column=1, row=3, padx=5, columnspan=2, sticky=W)
    RPM_MOT.grid(column=1, row=4, padx=5, columnspan=2, sticky=W)
    THROT_POS.grid(column=1, row=5, padx=5, columnspan=2, sticky=W)
    SHV_POS.grid(column=1, row=6, padx=5, columnspan=2, sticky=W)
