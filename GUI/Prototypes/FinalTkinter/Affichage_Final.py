...
frameCounterByte_nom = Label(gui, text="CAN DATA1: ")
runTime_nom = Label(gui, text="CAN DATA2: ")
speed_nom = Label(gui, text="CAN DATA3: ")
tpm_nom = Label(gui, text="CAN DATA4: ")
rpm_nom = Label(gui, text="CAN DATA5: ")
oilTemp_nom = Label(gui, text="CAN DATA6: ")
...
while (1):
    Hour_i, Minute_i, Second_i, Latitude_int_i, Latitude_frac_i, longitude_int_i, longitude_frac_i, canData1_i, canData2_i, canData3_i, canData4_i, canData5_i, canData6_i = MF.data()

    Hour.set(f'{Hour_i:04}')
    Minute.set(f'{Minute_i:04}')
    Second.set(f'{Second_i:04}')
    Latitude_int.set(f'{Latitude_int_i}')
    Latitude_frac.set(f'{Latitude_frac_i}')
    longitude_int.set(f'{longitude_int_i}')
    longitude_frac.set(f'{longitude_frac_i}')

    frameCounterByte.set(f'{canData1_i:04}')
    runTime.set(f'{canData2_i:04}')
    speed.set(f'{canData3_i:04}')
    speed.set(f'{canData4_i:04}')
    tpm.set(f'{canData5_i:04}')
    rpm.set(f'{canData6_i:04}')
